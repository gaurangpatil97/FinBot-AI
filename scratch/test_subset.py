...
craftsman_files = ['D:/FinBot/benchmarks/questions/craftsman_100.json', 'D:/FinBot/benchmarks/questions/craftsman_specific_60.json', 'D:/FinBot/benchmarks/questions/agnostic_40.json']

queries = [
    ('astral_ltd', 'CP4', find_q_anywhere('CP4', astral_files)),
    ('astral_ltd', 'P1', find_q_anywhere('P1', astral_files)),
    ('astral_ltd', 'P9', find_q_anywhere('P9', astral_files)),
    ('craftsman_automation_ltd', 'CP3', find_q_anywhere('CP3', craftsman_files)),
    ('craftsman_automation_ltd', 'P9', find_q_anywhere('P9', craftsman_files))
]
