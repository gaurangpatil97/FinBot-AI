...
export default function Sidebar({
  ...
  return (
    <aside className="flex w-full shrink-0 flex-col border-b border-white/8 bg-[#161b22] lg:h-screen lg:w-[295px] lg:border-b-0 lg:border-r lg:border-white/8 no-scrollbar overflow-x-hidden" style={{ overflow: "hidden", scrollbarWidth: "none" }}>
