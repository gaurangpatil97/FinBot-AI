...
import type { CollectionRecord, StockSummary } from "./finbot-types";
...
export default function Sidebar({
  ...
  return (
    <aside className="flex w-full shrink-0 flex-col border-b border-white/8 bg-[#161b22] lg:h-screen lg:w-[280px] lg:border-b-0 lg:border-r lg:border-white/8">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
        ...
        <CorpusStatus collections={collections} />
      </div>
